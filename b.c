...
insert()
{
...

    {
        ...
        sem_count++;
        add_item++;
        printf("Inset the element in queue : %d  and no. of elements in queue is %d \n",queue_array[rear],rear-front+1);
...
delete()
{
...

    {
        ...
        front = front + 1;
        sem_count--;
        printf("new front item is %d and rear item is %d and queue value is %d\n",queue_array[front],queue_array[rear],rear-front+1);
